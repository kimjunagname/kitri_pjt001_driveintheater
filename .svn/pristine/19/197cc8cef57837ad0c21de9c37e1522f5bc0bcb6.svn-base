...
public class UserLoginPanel extends JPanel {
  ...
  public UserLoginPanel() {
    ...
    idL.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 25));
    idL.setBounds(43, 212, 37, 30);
    add(idL);
    
    idintextp1 = new JTextField();
    idintextp1.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 20));
    idintextp1.setText("ID ÀÔ·Â ÇØÁÖ¼¼¿ä");
    idintextp1.setColumns(10);
    idintextp1.setBounds(117, 202, 224, 59);
    add(idintextp1);
    
    JLabel pwdL = new JLabel("PWD");
    pwdL.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 25));
    pwdL.setBounds(43, 308, 57, 30);
    add(pwdL);
    
    pwdintextp1 = new JPasswordField();
    pwdintextp1.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 20));
    ...
    joinButtonp1.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 12));
    joinButtonp1.setBounds(59, 395, 131, 48);
    add(joinButtonp1);
    
    loginButtonp1 = new JButton("LOGIN");
    loginButtonp1.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 12));
    loginButtonp1.setBounds(204, 395, 140, 48);
    add(loginButtonp1);
  

    pwdSuchButtenp1 = new JButton("PWD Ã£±â");
    pwdSuchButtenp1.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 14));
    pwdSuchButtenp1.setBounds(261, 505, 105, 30);
    add(pwdSuchButtenp1);
    
    idSuchButtenp1 = new JButton("ID Ã£±â");
    idSuchButtenp1.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 14));
