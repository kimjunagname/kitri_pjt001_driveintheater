...
public class SuperAdministratorGangSeoMonthView extends JPanel {

	private JTable gSDaysTable;
	/**
	 * Create the panel.
	 */
	public SuperAdministratorGangSeoMonthView() {
		...
		JLabel lblNewLabel = new JLabel("\uAC15\uC11C\uC9C0\uC5ED \uC6D4 \uB9E4\uCD9C\uD604\uD669");
		...
		gSDaysTable = new JTable();
		gSDaysTable.setBounds(12, 10, 389, 272);
		panel_3.add(gSDaysTable);
		...
		JLabel lblNewLabel_1 = new JLabel("\uAC15\uC11C\uC9C0\uC5ED \uC6D4 \uB9E4\uCD9C \uADF8\uB798\uD504");
		lblNewLabel_1.setBounds(124, 377, 132, 15);
		add(lblNewLabel_1);
		
		JLabel label = new JLabel("\uAC15\uC11C\uC9C0\uC5ED \uC6D4 \uB9E4\uCD9C \uD604\uD669");
