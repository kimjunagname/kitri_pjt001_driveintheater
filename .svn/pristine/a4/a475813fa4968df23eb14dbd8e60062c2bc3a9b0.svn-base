...
public class SuperAdministratorSalesGanNameDaysView extends JPanel {
	private JTable gNDaysTable;
	/**
	 * Create the panel.
	 */
	public SuperAdministratorSalesGanNameDaysView() {
		...
		JLabel lblNewLabel = new JLabel("\uAC15\uB0A8\uC9C0\uC5ED \uC77C \uB9E4\uCD9C\uD604\uD669");
		...
		gNDaysTable = new JTable();
		gNDaysTable.setBounds(12, 10, 389, 272);
		panel_3.add(gNDaysTable);
		...
		JLabel lblNewLabel_1 = new JLabel("\uAC15\uB0A8\uC9C0\uC5ED \uC77C \uB9E4\uCD9C \uADF8\uB798\uD504");
		lblNewLabel_1.setBounds(124, 377, 132, 15);
		add(lblNewLabel_1);
		
		JLabel label = new JLabel("\uAC15\uB0A8\uC9C0\uC5ED \uC77C \uB9E4\uCD9C \uD604\uD669");
