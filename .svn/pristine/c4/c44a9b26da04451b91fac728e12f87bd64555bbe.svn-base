    ...
    if (ob == login.p1.joinButtonp1) {// 회원가입 폼 이동
      ...
      if (userDto != null) {
        ...
        String name = userDto.getUser_name();
           ...
           System.out.println("컨트롤러 userDto" + userDto.getGrade_name());
           System.out.println("컨트롤러 userDto.getGrade_name():" + userDto.getGrade_name());          
