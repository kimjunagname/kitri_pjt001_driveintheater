...
COMMENT ON COLUMN USER_INFO.CARTYPE_NO IS '차종명';
...
INSERT into USER_INFO (USER_NO, USER_ID, USER_PWD, CARTYPE_NAME,USER_NAME,USER_EMAIL,  USER_PHONE)
               VALUES (USER_NO_SEQ.nextval, 'user1', 'user1', '소형차', '김정남', 'user1@test.com', '01093384137');

INSERT into USER_INFO (USER_NO, USER_ID, USER_PWD, CARTYPE_NAME, USER_NAME,USER_EMAIL,  USER_PHONE)
               VALUES (USER_NO_SEQ.nextval, 'user2', 'user2', '중형차', '김정남', 'user1@test.com', '01093384137');

INSERT into USER_INFO (USER_NO, USER_ID, USER_PWD, CARTYPE_NAME,USER_NAME,USER_EMAIL,  USER_PHONE)
               VALUES (USER_NO_SEQ.nextval, 'user3', 'user3', '대형차', '민규', 'user3@test.com', '01093384137');
commit;  
...
INSERT into EMP_INFO (EMP_NO,         EMP_ID, EMP_PWD, EMP_NAME,EMP_BIRTH, EMP_EMAIL,    EMP_PHONE,   JOB_NO, BRANCH_NO)
               VALUES (EMP_NO_SEQ .nextval, 'admin1', '1234', '김정남', sysdate, 'many@ma.com', '01093384137',      1,         1);
               
INSERT into EMP_INFO (EMP_NO,         EMP_ID, EMP_PWD, EMP_NAME,EMP_BIRTH, EMP_EMAIL, EMP_PHONE, JOB_NO, BRANCH_NO)
               VALUES (EMP_NO_SEQ .nextval, 'admin2', '1234', '이상규', sysdate, 'ma1@ma.com', '01093384137', 2, 1);
               
INSERT into EMP_INFO (EMP_NO,         EMP_ID, EMP_PWD, EMP_NAME,EMP_BIRTH, EMP_EMAIL, EMP_PHONE, JOB_NO, BRANCH_NO)
               VALUES (EMP_NO_SEQ .nextval, 'admin3', '1234', '민규', sysdate, 'ma2@ma.com', '01093384137', 3, 1);
               

INSERT into EMP_INFO (EMP_NO,         EMP_ID, EMP_PWD, EMP_NAME,EMP_BIRTH, EMP_EMAIL, EMP_PHONE, JOB_NO, BRANCH_NO)
               VALUES (EMP_NO_SEQ .nextval, 'admin4', '1234', '안효인', sysdate, 'ma3@ma.com', '01093384137', 1, 2);
               
INSERT into EMP_INFO (EMP_NO,         EMP_ID, EMP_PWD, EMP_NAME,EMP_BIRTH, EMP_EMAIL, EMP_PHONE, JOB_NO, BRANCH_NO)
               VALUES (EMP_NO_SEQ .nextval, 'admin5', '1234', '송민범', sysdate, 'ma4@ma.com', '01093384137', 2, 2);
               
INSERT into EMP_INFO (EMP_NO,         EMP_ID, EMP_PWD, EMP_NAME,EMP_BIRTH, EMP_EMAIL, EMP_PHONE, JOB_NO, BRANCH_NO)
               VALUES (EMP_NO_SEQ .nextval, 'admin6', '1234', '집에', sysdate, 'ma5@ma.com', '01093384137', 3, 2);
...
CREATE TABLE TICKET_PAY (
	...
	TICKET_SHOWTIME VARCHAR2(30) /* 상영시간 */
);
...
COMMENT ON COLUMN TICKET_PAY.TICKET_SHOWTIME IS '상영시간';
...
/*결제 테이블 값 대입*/
INSERT into TICKET_PAY(TICKET_PAYNO, USER_NO, BRANCH_NO, MOVIE_NO, TICKET_PAYTOTAL,
                     TICKET_PAYCASH,TICKET_PAYMILEAGE,TICKET_SALCOUNT,TICKET_PAYDATE,MOVIE_PALYDATE)
               VALUES (PAY_NO_SEQ.nextval, 1, 1, 81, 5000, 
                                     3000, 2000, 1, sysdate,TO_DATE('2018/05/15 15:09:05','yyyy/mm.dd hh24:mi:ss'));
                                     
INSERT into TICKET_PAY(TICKET_PAYNO, USER_NO, BRANCH_NO, MOVIE_NO, TICKET_PAYTOTAL,
                     TICKET_PAYCASH,TICKET_PAYMILEAGE,TICKET_SALCOUNT,TICKET_PAYDATE,MOVIE_PALYDATE)
               VALUES (PAY_NO_SEQ.nextval, 2, 1, 82, 5000, 
                                     3000, 2000, 1, sysdate,TO_DATE('2018/05/17 15:09:05','yyyy/mm.dd hh24:mi:ss'));
...
/* 차량관리 데이터 생성*/
INSERT INTO car_manage values(1, '소형차', 5000);
INSERT INTO car_manage values(2, '중형차', 8000);
INSERT INTO car_manage values(3, '대형차', 9000);        
...
INSERT INTO USER_MILEAGE VALUES(1,3000,5);
INSERT INTO USER_MILEAGE VALUES(2,5000,10);
INSERT INTO USER_MILEAGE VALUES(3,4000,7);
...
INSERT INTO BRANCH_MOVIE VALUES(81, 1, )
select * from MOVIE_INFO;


/* 지점별 상영 관리 테이블 데이터 Insert */
INSERT INTO BRANCH_MOVIE(MOVIE_NO, BRANCH_NO, MOVIE_STARTDATE, MOVIE_ENDDATE, MOVIE_START1, MOVIE_START2, MOVIE_START3)
VALUES(81, 1, TO_DATE('2018/05/17 15:09:05','yyyy/mm.dd hh24:mi:ss'), TO_DATE('2018/05/19 15:09:00', 'yyyy/mm.dd hh24:mi:ss'),'08:00','16:00','18:00');

INSERT INTO BRANCH_MOVIE 
VALUES(82, 2, TO_DATE('2018/05/17 15:09:16','yyyy/mm.dd hh24:mi:ss'), TO_DATE('2018/05/20 15:09:16', 'yyyy/mm.dd hh24:mi:ss'),'08:00','16:00','18:00');

INSERT INTO BRANCH_MOVIE 
VALUES(83, 3, TO_DATE('2018/05/17 00:00:00','yyyy/mm.dd hh24:mi:ss'), TO_DATE('2018/05/30 00:00:00', 'yyyy/mm.dd hh24:mi:ss'), '10:00','15:00','18:00');

INSERT INTO BRANCH_MOVIE 
VALUES(83, 1, TO_DATE('2018/05/17 00:00:00','yyyy/mm.dd hh24:mi:ss'), TO_DATE('2018/05/30 00:00:00', 'yyyy/mm.dd hh24:mi:ss'), '10:00','15:00','18:00');
commit;
select * from user_info;
select * from BRANCH_MOVIE;
DELETE FROM BRANCH_MOVIE WHERE branch_no = 1;
DELETE FROM BRANCH_MOVIE WHERE branch_no = 2;
DELETE FROM BRANCH_MOVIE WHERE branch_no = 3;

ORA-02291: integrity constraint (CAR.FK_MOVIE_INFO_TO_TICKET_PAY) violated - parent key not found
