...
public class SuperAdministratorSalesGangBukMonthView extends JPanel {

	private JTable gBDaysTable;
	/**
	 * Create the panel.
	 */
	public SuperAdministratorSalesGangBukMonthView() {
		...
		JLabel lblNewLabel = new JLabel("\uAC15\uBD81\uC9C0\uC5ED \uC6D4 \uB9E4\uCD9C\uD604\uD669");
		...
		gBDaysTable = new JTable();
		gBDaysTable.setBounds(12, 10, 389, 272);
		panel_3.add(gBDaysTable);
		...
		JLabel lblNewLabel_1 = new JLabel("\uAC15\uBD81\uC9C0\uC5ED \uC6D4 \uB9E4\uCD9C \uADF8\uB798\uD504");
		lblNewLabel_1.setBounds(124, 377, 132, 15);
		add(lblNewLabel_1);
		
		JLabel label = new JLabel("\uAC15\uBD81\uC9C0\uC5ED \uC6D4 \uB9E4\uCD9C \uD604\uD669");
