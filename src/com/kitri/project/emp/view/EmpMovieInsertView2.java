...
public class EmpMovieInsertView2 extends JPanel {
	...
	public EmpMovieInsertView2() {
				...
				posterApplybtn.addActionListener(new ActionListener() {
				...
				textField.setBounds(123, 236, 161, 24);
				panel_1.add(textField);
				textField.setColumns(10);
				
				textField_1 = new JTextField();
				textField_1.setBounds(123, 291, 161, 24);
