...
public class SuperAdminMovieDeleteModifyPanel extends JPanel {
	public static final String superAdminChartPanel = null;
  ...
  public Vector<Vector<String>> rowData; // rowData = DB에 입출력되는 데이터
	 ...
	 * Create the panel.
	 */
	public SuperAdminMovieDeleteModifyPanel() {
