...
public class UserBenefitPanel extends JPanel {
	...
	public UserBenefitPanel() {
		...
		upBtn.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 15));
		upBtn.setBounds(98, 331, 219, 69);
		add(upBtn);
		
		back = new JButton("BACK"); // µÚ·Î°¡±â ¹öÆ°
		back.setBackground(new Color(0, 204, 255));
		back.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 12));
		back.setBounds(12, 10, 68, 30); // µÚ·Î°¡±â ¹öÆ°
		add(back);
