...
//  public UserMemberJoin p2= new UserMemberJoin();
  ...
  public UserLogin() {
    ...
    p1.title.setFont(new Font("맑은 고딕", Font.BOLD, 30));
    p1.joinButtonp1.setFont(new Font("맑은 고딕", Font.PLAIN, 12));
    p1.loginButtonp1.setFont(new Font("맑은 고딕", Font.PLAIN, 12));
    p1.idSuchButtenp1.setFont(new Font("맑은 고딕", Font.PLAIN, 14));
    p1.pwdSuchButtenp1.setFont(new Font("맑은 고딕", Font.PLAIN, 14));
    p1.setBackground(Color.WHITE);
    
    panel.add("loginView1", p1);
    p2.BackButtenP5.setFont(new Font("맑은 고딕", Font.PLAIN, 12));
    p2.label.setFont(new Font("맑은 고딕", Font.BOLD, 18));
