...
public class UserLoginPWDLookPanel1 extends JPanel {
  ...
  public JButton cancelButtonp4; //√Îº“ butten
  public JButton suchButtenP4; //¡∂»∏ butten
  ...
  public UserLoginPWDLookPanel1() {
    ...
    lblPwd.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.BOLD, 30));
    lblPwd.setBounds(117, 109, 173, 30);
    add(lblPwd);
    
    JLabel label_1 = new JLabel("ID");
    label_1.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.PLAIN, 25));
    label_1.setBounds(14, 209, 100, 24);
    add(label_1);
    
    idTextP4 = new JTextField();  //idtext
    idTextP4.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.PLAIN, 25));//idtext
    ...
    emailTextP4.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.PLAIN, 25));//email text
    ...
    backButtonP4.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.PLAIN, 12));
    backButtonP4.setBackground(new Color(51, 204, 255));
    backButtonP4.setBounds(14, 12, 68, 30); //back butten
    add(backButtonP4);
    
//    cancelButtonp4 = new JButton("\uCDE8\uC18C"); //√Îº“ butten
//    cancelButtonp4.setBounds(198, 474, 82, 30); //√Îº“ butten
//    add(cancelButtonp4);
    
    suchButtenP4 = new JButton("\uC870\uD68C"); //¡∂»∏ butten
    suchButtenP4.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.PLAIN, 12));
    suchButtenP4.setBackground(new Color(51, 204, 255));
    suchButtenP4.setBounds(285, 474, 82, 30); //¡∂»∏ butten
    add(suchButtenP4);
