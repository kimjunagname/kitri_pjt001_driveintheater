...
public class UserMemberJoinPanel2 extends JPanel {
	...
	public UserMemberJoinPanel2() {
		...
		passwordFieldP5_1.setFont(new Font("맑은 고딕", Font.PLAIN, 15));
		...
		passwordFieldP5_2.setFont(new Font("맑은 고딕", Font.PLAIN, 15));
...
//  choic 사용방법
    ...
    carModelCP5.setFont(new Font("맑은 고딕", Font.PLAIN, 15));
	...
	//	carModelCP5.setBounds(75, 215, 283, 30);
		...
		nameTextp5.setFont(new Font("맑은 고딕", Font.PLAIN, 15));
		...
		emailTextP5.setFont(new Font("맑은 고딕", Font.PLAIN, 15));
		emailTextP5.setBounds(75, 317, 283, 30);
		add(emailTextP5);
		
		JLabel phoneL = new JLabel("PHONE"); 
		phoneL.setFont(new Font("맑은 고딕", Font.PLAIN, 15));
		...
		phoneTextP5.setFont(new Font("맑은 고딕", Font.PLAIN, 15));
