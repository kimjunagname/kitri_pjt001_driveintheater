...
public class UserMenu extends JFrame {
	...
	public JButton logoutButton; // ·Î±×¾Æ¿ô
	public JPanel panel;
...
//	public UserMovieReservationCancelPanel p8 = new UserMovieReservationCancelPanel();
	...
	public UserLogin userLogin; // ·Î±×ÀÎ Ã¢
	...
	public UserMenu() {
		...
		userName.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 18));
		userName.setBounds(12, 10, 76, 20);
		getContentPane().add(userName);

		logoutButton = new JButton("\uB85C\uADF8\uC544\uC6C3");// ·Î±×¾Æ¿ô
		logoutButton.setBackground(new Color(51, 204, 255));
		logoutButton.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 12));
		...
		p1.ticketPayBtn.setText("¿µÈ­¿¹¸Å ³»¿ª");
...
//		p1.log.addActionListener(control);// ·Î±×¾Æ¿ô ¸®½º³Ê
		...
		p4.backP2.addActionListener(control); //µÚ·Î°¡±â
		p4.payCancleP2.addActionListener(control); //°áÀçÃë¼Ò
...
//		p8.payCancleP2.addActionListener(control);
		...
		userGrade.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 15));
