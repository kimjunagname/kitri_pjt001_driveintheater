...
public class UserModifyInfoPanel extends JPanel {
	...
	public UserModifyInfoPanel() {
		...
		idL.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 15));
		...
		pwdL.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 15));
		pwdL.setBounds(12, 100, 37, 30);
		add(pwdL);
		
		JLabel carModelL = new JLabel("\uCC28\uC885");
		carModelL.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 15));
		...
		nameL.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 15));
		...
		phoneL.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 15));
