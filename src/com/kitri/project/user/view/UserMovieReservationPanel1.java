...
public class UserMovieReservationPanel1 extends JPanel {
	...
	public UserMovieReservationPanel1() {
		...
		choice = new Choice();
		choice.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 12));
		...
		backB.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 12));
		...
		titleL.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 25));
		titleL.setBounds(199, 10, 141, 35);
		add(titleL);

		reservationB = new JButton("¿¹¸Å");
		reservationB.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 12));
		...
		p1_1.rateL.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 13));
		p1_1.titleL.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 20));
		p1_1.slider.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 12));
		p1_1.posterL.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 12));
		...
		movieInfoB.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 12));
