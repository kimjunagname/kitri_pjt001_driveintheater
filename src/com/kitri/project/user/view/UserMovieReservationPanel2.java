...
public class UserMovieReservationPanel2 extends JPanel {
	...
	public UserMovieReservationPanel2() {
		...
		branchL.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 12));
		...
		label_9.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 23));
